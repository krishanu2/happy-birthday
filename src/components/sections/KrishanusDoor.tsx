...
const SCRIPT: Line[] = [
  ...
  // ── The roast ──
  { speaker: 'pig',       text: 'She had to remind you last year too.',                           pigExpr: 'sheepish',kExpr: 'sheepish', delay: 48200, duration: 3200 },
  { speaker: 'krishanu',  text: 'That was different.',                                            pigExpr: 'idle',    kExpr: 'sheepish', delay: 51400, duration: 2400 },
  { speaker: 'pig',       text: 'You sent a "happy birthday" at 11:58 PM.',                      pigExpr: 'gasp',    kExpr: 'sheepish', delay: 53800, duration: 3400 },
  { speaker: 'krishanu',  text: '...it was still the same day.',                                  pigExpr: 'idle',    kExpr: 'sheepish', delay: 57200, duration: 2800 },
  { speaker: 'pig',       text: 'Go. Make something. NOW.',                                       pigExpr: 'serious', kExpr: 'sheepish', delay: 60000, duration: 2800 },
  // ── Scribbling ──
  { speaker: 'narrator',  text: '*frantic pencil sounds from inside*',                            pigExpr: 'idle',    kExpr: 'scribble', delay: 62800, duration: 3000 },
  { speaker: 'pig',       text: '...Is that a pencil?',                                           pigExpr: 'idle',    kExpr: 'scribble', delay: 65800, duration: 2600 },
  { speaker: 'krishanu',  text: 'I\'m DRAWING. It\'s ART.',                                      pigExpr: 'sheepish',kExpr: 'scribble', delay: 68400, duration: 2800 },
  { speaker: 'pig',       text: 'You Googled "how to draw a nose" didn\'t you.',                 pigExpr: 'idle',    kExpr: 'scribble', delay: 71200, duration: 3000 },
  { speaker: 'krishanu',  text: '...Twice.',                                                      pigExpr: 'sheepish',kExpr: 'scribble', delay: 74200, duration: 3000 },
  { speaker: 'narrator',  text: '*more intense scribbling*',                                      pigExpr: 'idle',    kExpr: 'scribble', delay: 77200, duration: 2800 },
  { speaker: 'krishanu',  text: 'Done. Is it good?',                                             pigExpr: 'idle',    kExpr: 'proud',    delay: 80000, duration: 2800 },
  { speaker: 'pig',       text: '*adjusts glasses* It\'s... present on the page.',               pigExpr: 'sheepish',kExpr: 'proud',    delay: 82800, duration: 3200 },
  { speaker: 'krishanu',  text: 'That\'s not—',                                                   pigExpr: 'idle',    kExpr: 'proud',    delay: 86000, duration: 2200 },
  { speaker: 'pig',       text: 'Send it. She\'ll love it.',                                     pigExpr: 'serious', kExpr: 'proud',    delay: 88200, duration: 3000 },
  { speaker: 'narrator',  text: '*paper airplane sails out the window into the cosmos*',          pigExpr: 'gasp',    kExpr: 'proud',    delay: 91200, duration: 2400 },
];
